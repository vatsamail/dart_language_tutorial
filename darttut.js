...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    divideNums: function(num1, num2) {
      var output, exception, t1, t2, t3;
      output = "";
      try {
        if (num2 === 0)
          throw H.wrapException(new A.DivideByZeroError("Error"));
        else
          output = J.$add$ns(output, "" + num1 + " / " + num2 + " = " + H.S(num1 / num2) + "\n");
      } catch (exception) {
        if (H.unwrapException(exception) instanceof A.DivideByZeroError)
          output = J.$add$ns(output, "Can't Divide by Zero\n");
        else
          throw exception;
      }
